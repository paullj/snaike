...
const isSimilar = (a: Organism, b: Organism, config: Config = DefaultConfig): boolean => {
  // FIXME: Not a massive fan of this way of getting config values...
  return distance(a, b, config) <= config.maxCompatibilityDistance!;
};

export const distance = (a: Organism, b: Organism, config: Config = DefaultConfig): number => {
...
const crossover = (a: Organism, b: Organism): Organism => {
